...
void ObjectCode::calculateObjectCode(std::string address,std::string opCode, std::string operand)
{
    ...
    else
    {
        ...
        else if (operand.compare("*") == 0)
        {
            string out = "3f0";
            string res = address;
            if (address.length() < 5 && (opCode.find('+') != std::string::npos))
            {
                int n = res.length();
                for(int i = 0; i < (5 - n); i++)
                {
            ...
            else if (address.length() < 3 && (opCode.find('+') == std::string::npos))
            {
                int n = res.length();
                for(int i = 0; i < (3 - n); i++)
                {
            ...
            else if (address.length() > 5 && (opCode.find('+') != std::string::npos))
            {
                int n = res.length();
                for(int i = 0; i < (3 - n); i++)
                {
